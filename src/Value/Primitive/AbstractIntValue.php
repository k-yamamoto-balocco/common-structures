...
use GitBalocco\CommonStructures\Value\Validator\Primitive\IntValueValidator;
 ...
 * @method int getValue()
 */
abstract class AbstractIntValue extends Value implements ValueInterface
{
    protected static function validatorClassName(): string
    {
        return IntValueValidator::class;
    }
